...
// removeing specific runScript in the project's build phase

pbxProject.prototype.removeRunScript = function (scriptName) {
    var section = this.hash.project.objects['PBXShellScriptBuildPhase'],
        key, itemKey;
